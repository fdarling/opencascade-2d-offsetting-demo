...
CPP_ARGS="booleans ./tests/polygon_with_2_holes.txt ./tests/input_circle_offset.txt ./tests/booleans_output_001.txt union"
#CPP_ARGS="booleans ./tests/input_001.txt ./tests/input_001_small_off_10.txt ./tests/booleans_output_001.txt difference"
#CPP_ARGS="offset ./tests/polygon_with_2_holes.txt ./tests/polygon_with_2_holes_offset.txt -0.6 arc"
#CPP_ARGS="offset ./tests/polygon_with_2_holes.txt ./tests/polygon_with_2_holes_offset.txt -0.4 arc"
